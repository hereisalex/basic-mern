      ...
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText">
            <b>Xiaowei Zhang</b> and <b>3 other friends</b> have a birthday
            today!
          </span>
        </div>
        ...
        <>
            ...
            <div className="rightbarInfo">
                <div className="rightbarInfoItem">
                    ...
                    <span className="rightbarInfoValue">Minneapolis</span>
                </div>
                <div className="rightbarInfoItem">
                    <span className="rightbarInfoKey">From: </span>
                    <span className="rightbarInfoValue">Chaska</span>
                </div>
                <div className="rightbarInfoItem">
